...
@section('content')
<!-- Slotted content -->
<h2>Hồ Sơ Của {{$teacher->initials}} {{$teacher->last_name ?? $teacher->first_name}}</h2>
            ...
            <div class="card mb-3">
                <div class="card-body text-center">
                    ...
                    <div class="d-flex justify-content-center mb-2">
                        <a href="/admin/teachers/{{$teacher->id}}/edit" class="btn btn-warning">Chỉnh sửa</a>
        ...
        <div class="row">
            <div class="col-lg-4">
                <div class="card mb-4 mb-md-0">
                    <div class="card-body">
                        <p class="mb-4">Môn Học Được Gán</p>
