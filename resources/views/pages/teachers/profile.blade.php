    ...
    <div class="container row">
        <div class="col-md-4">
            <div class="card text-center" style="width: 14rem;">
                ...
                <div class="card-body">
                    <h5 class="card-title">Admin (Chắc là giáo viên)</h5>
                    <a href="/admin/settings" class="btn btn-outline-warning">Cài đặt</a>
                </div>
            </div>
        </div>
        <div class="col-md-8">
            ...
            <div class="mb-3">
                <label for="date_created" class="form-label">Tạo lúc: </label>
                <input type="text" value="{{auth()->user()->created_at}}" name="date_created" id="date_created" class="form-control" readonly>
            </div>
            <div class="mb-3">
                <label for="date_updated" class="form-label">Cập nhật lúc: </label>
